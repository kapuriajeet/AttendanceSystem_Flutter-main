  ...
  Future joinClassFunc(String code) async {
    try {
      ...
      var response1 = await http.post(Uri.parse(url1),
          body: {'class_code': class_CODE_GLOBAL.toString()});
      ...
      var final_post_url1 =
          "https://gopunchin.000webhostapp.com/create_new_student_classroom_entry.php";
  ...
  Widget build(BuildContext context) {
    void submit() {
      Navigator.of(context)
          .pop(controller.text); // TO Disable the openned alert window.
    }
